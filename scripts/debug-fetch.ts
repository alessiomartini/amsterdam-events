...
const TARGETS: Record<string, string> = {
  nominatimBimhuis: "https://nominatim.openstreetmap.org/search?q=Bimhuis%2C+Amsterdam&format=json&limit=1",
  nominatimOt301: "https://nominatim.openstreetmap.org/search?q=OT301%2C+Overtoom+301%2C+Amsterdam&format=json&limit=1",
};
